<?php
    ...
    $preference->back_urls = array(
        "success" => "https://msbombieri-mp-ecommerce-php.herokuapp.com/success.php",
        "failure" => "https://msbombieri-mp-ecommerce-php.herokuapp.com/failure.php",
        "pending" => "https://msbombieri-mp-ecommerce-php.herokuapp.com/pending.php"
    );
